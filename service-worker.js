...
async function prepareAppHtml(response){
 ...
 if(!html.includes('firebase-auth-compat.js'))html=html.replace('</head>',`${authScript}\n</head>`);
 ...
 const mainStyle='<link rel="stylesheet" href="./homebase-ui-1.8.3.css?v=11025" data-homebase-ui="1.10.25">';
 const fixesStyle='<link rel="stylesheet" href="./homebase-fixes-1.9.2.css?v=11025" data-homebase-fixes="1.10.25">';
 const qualityStyle='<link rel="stylesheet" href="./homebase-quality-1.9.7.css?v=11025" data-homebase-quality="1.10.25">';
 const appleGlassStyle='<link rel="stylesheet" href="./homebase-apple-glass-1.10.2.css?v=11025" data-homebase-apple-glass="1.10.25">';
 const shellStyle='<link rel="stylesheet" href="./homebase-shell-1.10.3.css?v=11025" data-homebase-shell="1.10.25">';
 ...
 const scripts=[];
 if(!html.includes("homebase-ui-1.8.3.js"))scripts.push('<script src="./homebase-ui-1.8.3.js?v=11025"></script>');
 if(!html.includes("roster-sync-fix.js"))scripts.push('<script src="./roster-sync-fix.js?v=11025"></script>');
 if(!html.includes("homebase-quality-1.9.7.js"))scripts.push('<script src="./homebase-quality-1.9.7.js?v=11025"></script>');
 if(!html.includes("homebase-shell-1.10.3.js"))scripts.push('<script src="./homebase-shell-1.10.3.js?v=11025"></script>');
 if(!html.includes("homebase-nozoom-1.10.10.js"))scripts.push('<script src="./homebase-nozoom-1.10.10.js?v=11025"></script>');
 if(!html.includes("homebase-calendar-jump-1.10.13.js"))scripts.push('<script src="./homebase-calendar-jump-1.10.13.js?v=11025"></script>');
 if(!html.includes("production-security-auth.js"))scripts.push('<script src="./production-security-auth.js?v=11025"></script>');
 if(!html.includes("homebase-expiry-sync-1.10.14.js"))scripts.push('<script src="./homebase-expiry-sync-1.10.14.js?v=11025"></script>');
 if(!html.includes("homebase-profile-enhancements-1.10.16.js"))scripts.push('<script src="./homebase-profile-enhancements-1.10.16.js?v=11025"></script>');
 if(!html.includes("homebase-expiry-owner-fix-1.10.18.js"))scripts.push('<script src="./homebase-expiry-owner-fix-1.10.18.js?v=11025"></script>');
 if(!html.includes("homebase-expiry-owner-hotfix-1.10.19.js"))scripts.push('<script src="./homebase-expiry-owner-hotfix-1.10.19.js?v=11025"></script>');
 if(!html.includes("production-tools.js"))scripts.push('<script src="./production-tools.js?v=11025"></script>');
 if(!html.includes("homebase-expiries-1.10.21.js"))scripts.push('<script src="./homebase-expiries-1.10.21.js?v=11025"></script>');
