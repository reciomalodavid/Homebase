/* Homebase stable 1.10.16 · fotos de perfil y acciones alineadas */
const SHELL_CACHE="homebase-1.10.16";
const RUNTIME_CACHE="homebase-1.10.16";
const SHELL=["./","./index.html","./manifest.webmanifest","./apple-touch-icon.png","./icon-192.png","./icon-512.png","./roster-sync-fix.js","./homebase-ui-1.8.3.js","./homebase-ui-1.8.3.css","./homebase-fixes-1.9.2.css","./homebase-quality-1.9.7.js","./homebase-quality-1.9.7.css","./homebase-apple-glass-1.10.2.css","./homebase-shell-1.10.3.css","./homebase-shell-1.10.3.js","./homebase-nozoom-1.10.10.js","./homebase-calendar-jump-1.10.13.js","./homebase-expiry-sync-1.10.14.js","./homebase-profile-enhancements-1.10.16.js"];
...
async function prepareAppHtml(response){
 ...
 const mainStyle='<link rel="stylesheet" href="./homebase-ui-1.8.3.css?v=11016" data-homebase-ui="1.10.16">';
 const fixesStyle='<link rel="stylesheet" href="./homebase-fixes-1.9.2.css?v=11016" data-homebase-fixes="1.10.16">';
 const qualityStyle='<link rel="stylesheet" href="./homebase-quality-1.9.7.css?v=11016" data-homebase-quality="1.10.16">';
 const appleGlassStyle='<link rel="stylesheet" href="./homebase-apple-glass-1.10.2.css?v=11016" data-homebase-apple-glass="1.10.16">';
 const shellStyle='<link rel="stylesheet" href="./homebase-shell-1.10.3.css?v=11016" data-homebase-shell="1.10.16">';
 ...
 const scripts=[];
 if(!html.includes("homebase-ui-1.8.3.js"))scripts.push('<script src="./homebase-ui-1.8.3.js?v=11016"></script>');
 if(!html.includes("roster-sync-fix.js"))scripts.push('<script src="./roster-sync-fix.js?v=11016"></script>');
 if(!html.includes("homebase-quality-1.9.7.js"))scripts.push('<script src="./homebase-quality-1.9.7.js?v=11016"></script>');
 if(!html.includes("homebase-shell-1.10.3.js"))scripts.push('<script src="./homebase-shell-1.10.3.js?v=11016"></script>');
 if(!html.includes("homebase-nozoom-1.10.10.js"))scripts.push('<script src="./homebase-nozoom-1.10.10.js?v=11016"></script>');
 if(!html.includes("homebase-calendar-jump-1.10.13.js"))scripts.push('<script src="./homebase-calendar-jump-1.10.13.js?v=11016"></script>');
 if(!html.includes("homebase-expiry-sync-1.10.14.js"))scripts.push('<script src="./homebase-expiry-sync-1.10.14.js?v=11016"></script>');
 if(!html.includes("homebase-profile-enhancements-1.10.16.js"))scripts.push('<script src="./homebase-profile-enhancements-1.10.16.js?v=11016"></script>');
