const SHELL_CACHE="homebase-1.10.5";
const RUNTIME_CACHE="homebase-1.10.5";
...
async function prepareAppHtml(response){
 ...
 const mainStyle='<link rel="stylesheet" href="./homebase-ui-1.8.3.css?v=1105" data-homebase-ui="1.10.5">';
 const fixesStyle='<link rel="stylesheet" href="./homebase-fixes-1.9.2.css?v=1105" data-homebase-fixes="1.10.5">';
 const qualityStyle='<link rel="stylesheet" href="./homebase-quality-1.9.7.css?v=1105" data-homebase-quality="1.10.5">';
 const appleGlassStyle='<link rel="stylesheet" href="./homebase-apple-glass-1.10.2.css?v=1105" data-homebase-apple-glass="1.10.5">';
 const shellStyle='<link rel="stylesheet" href="./homebase-shell-1.10.3.css?v=1105" data-homebase-shell="1.10.5">';
 ...
 const scripts=[];
 if(!html.includes("homebase-ui-1.8.3.js"))scripts.push('<script src="./homebase-ui-1.8.3.js?v=1105"></script>');
 if(!html.includes("roster-sync-fix.js"))scripts.push('<script src="./roster-sync-fix.js?v=1105"></script>');
 if(!html.includes("homebase-quality-1.9.7.js"))scripts.push('<script src="./homebase-quality-1.9.7.js?v=1105"></script>');
 if(!html.includes("homebase-shell-1.10.3.js"))scripts.push('<script src="./homebase-shell-1.10.3.js?v=1105"></script>');
