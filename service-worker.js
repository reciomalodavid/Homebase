const SHELL_CACHE="homebase-1.9.4";
const RUNTIME_CACHE="homebase-1.9.4";
const SHELL=["./","./index.html","./manifest.webmanifest","./apple-touch-icon.png","./icon-192.png","./icon-512.png","./roster-sync-fix.js","./homebase-ui-1.8.3.js","./homebase-ui-1.8.3.css","./homebase-fixes-1.9.2.css"];
...
async function prepareAppHtml(response){
 ...
 const mainStyle='<link rel="stylesheet" href="./homebase-ui-1.8.3.css?v=194" data-homebase-ui="1.9.4">';
 const fixesStyle='<link rel="stylesheet" href="./homebase-fixes-1.9.2.css?v=194" data-homebase-fixes="1.9.4">';
 ...
 const scripts=[];
 if(!html.includes("homebase-ui-1.8.3.js"))scripts.push('<script src="./homebase-ui-1.8.3.js?v=194"></script>');
 if(!html.includes("roster-sync-fix.js"))scripts.push('<script src="./roster-sync-fix.js?v=194"></script>');
 ...
 if(request.mode==="navigate"){
  event.respondWith(
   fetch(new Request(request,{cache:"no-store"}))
    ...
    .catch(async()=>{const cached=await caches.match("./index.html");return cached?prepareAppHtml(cached):Response.error()})
  );
  return;
 }
