const SHELL_CACHE="homebase-1.9.2";
const RUNTIME_CACHE="homebase-1.9.2";
...
async function prepareAppHtml(response){
 ...
 const mainStyle='<link rel="stylesheet" href="./homebase-ui-1.8.3.css?v=192" data-homebase-ui="1.9.2">';
 const fixesStyle='<link rel="stylesheet" href="./homebase-fixes-1.9.2.css?v=192" data-homebase-fixes="1.9.2">';
 ...
 const scripts=[];
 if(!html.includes("homebase-ui-1.8.3.js"))scripts.push('<script src="./homebase-ui-1.8.3.js?v=192"></script>');
 if(!html.includes("roster-sync-fix.js"))scripts.push('<script src="./roster-sync-fix.js?v=192"></script>');
