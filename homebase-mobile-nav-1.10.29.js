...
function installStyles(){
 ...
 .bottom-nav{left:12px!important;right:12px!important;bottom:calc(8px + env(safe-area-inset-bottom))!important;width:calc(100vw - 24px)!important;max-width:calc(100vw - 24px)!important;height:70px!important;min-height:70px!important;padding:7px!important;display:grid!important;grid-template-columns:minmax(0,1fr) minmax(0,1fr) 62px minmax(0,1fr) minmax(0,1fr)!important;align-items:stretch!important;column-gap:1px!important;border-radius:30px!important;overflow:visible!important;background:rgba(255,252,248,.96)!important;border:1px solid rgba(255,255,255,.98)!important;box-shadow:0 12px 30px rgba(67,48,31,.14),inset 0 1px 0 rgba(255,255,255,.98)!important;-webkit-backdrop-filter:blur(28px) saturate(170%)!important;backdrop-filter:blur(28px) saturate(170%)!important}
 ...
 .bottom-nav .nav-btn.active,.bottom-nav .active,.bottom-nav [aria-current="page"]{background:linear-gradient(145deg,#ff901d,#e66f07)!important;color:#fff!important;box-shadow:0 7px 18px rgba(224,99,7,.34),0 0 0 1px rgba(255,255,255,.18) inset,0 0 26px rgba(255,145,32,.24)!important;text-shadow:0 1px 1px rgba(110,45,0,.12)!important}
 .bottom-nav .nav-btn.active *,.bottom-nav .active *,.bottom-nav [aria-current="page"] *{color:#fff!important}
 ...
 #eventFab,.event-fab,.fab,button.fab,[aria-label="Nuevo"].floating,.floating-add{position:fixed!important;left:50%!important;right:auto!important;bottom:calc(56px + env(safe-area-inset-bottom))!important;width:58px!important;height:58px!important;min-width:58px!important;min-height:58px!important;margin:0!important;padding:0!important;transform:translateX(-50%)!important;border-radius:50%!important;border:1px solid rgba(255,255,255,.82)!important;background:linear-gradient(145deg,#ff9222,#ed7308)!important;color:#fff!important;box-shadow:0 9px 21px rgba(224,101,7,.30),inset 0 1px 0 rgba(255,255,255,.28)!important;z-index:940!important;display:grid!important;place-items:center!important;font-size:34px!important;line-height:1!important}
...
function enforceActiveTab(){
 ...
 for(const tab of tabs){
  ...
  if(active){
   tab.style.setProperty('background','linear-gradient(145deg,#ff901d,#e66f07)','important');
   tab.style.setProperty('color','#fff','important');
   tab.style.setProperty('box-shadow','0 7px 18px rgba(224,99,7,.34),0 0 26px rgba(255,145,32,.24),inset 0 1px 0 rgba(255,255,255,.26)','important');
  }else{
...
function applyUx(){hideDuplicatePendingBlock();renameMoreToManagement();hidePendingNewButton();keepQuickAddVisible();enforceActiveTab()}
