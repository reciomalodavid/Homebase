...
function installStyles(){
 ...
 .bottom-nav .active,.bottom-nav [aria-current="page"]{background:linear-gradient(145deg,#ff921f,#e97208)!important;color:#fff!important;box-shadow:0 5px 16px rgba(234,112,9,.26),0 0 22px rgba(255,151,47,.16),inset 0 1px 0 rgba(255,255,255,.30)!important;text-shadow:0 1px 1px rgba(110,45,0,.10)!important}
 .bottom-nav .active *,.bottom-nav [aria-current="page"] *{color:#fff!important}
...
function after(){requestAnimationFrame(()=>requestAnimationFrame(applyUx));setTimeout(applyUx,120)}
