...
function patch(){
  ...
  if(cloudPayload.__productionSecurityGuard)return true;
  ...
  wrapped.__productionSecurityGuard=true;
...
window.HOMEBASE_SECURITY_PAYLOAD_GUARD={version:VERSION,patch};
})();