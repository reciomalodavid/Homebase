...
const QUOTES=[
 ...
 "No puedes evitarles todas las dificultades. Sí enseñarles cómo atravesarlas.",
 ...
 "El hecho y lo que te cuentas sobre el hecho no son la misma cosa.",
 ...
 "Muchas veces sufres dos veces: una por lo que ocurre y otra por lo que imaginas que significa.",
 ...
 "Tu trabajo termina en elegir bien, no en garantizar el resultado.",
 ...
 "Evitar todo lo difícil acaba haciendo difícil casi todo.",
 "No necesitas sentirte fuerte antes de soportar algo. A veces te vuelves fuerte soportándolo.",
 ...
 "No controlas lo que ocurre. Sí qué clase de persona eres cuando ocurre.",
 "Lo inevitable ya tiene suficiente peso. No le añadas el de resistirte a que haya ocurrido.",
 "No necesitas que algo salga bien para haber actuado bien.",
 ...
 "No midas cada acción por lo que ganas. Algunas se justifican por la persona que te obligan a ser.",
 ...
 "Aceptar que estabas equivocado cuesta menos que seguir defendiendo un error.",
 "La inteligencia también consiste en saber qué evidencia te haría cambiar de opinión.",
 "No controles cada resultado de quienes quieres. Ayúdales a construir carácter para enfrentarlo.",
 ...
 "No necesitas más tiempo para todo. Necesitas decidir mejor qué merece el que tienes.",
 "Recordar que vas a morir sirve para dejar de vivir como si todo pudiera esperar.",
 ...
 "La muerte no vuelve urgente todo. Vuelve urgente distinguir qué importa.",
 ...
 "Tus hijos aprenderán más de cómo atraviesas un mal día que de lo que les expliques sobre fortaleza.",
 ...
 "Si una crítica es cierta, úsala. Si no lo es, no necesitas cargarla.",
