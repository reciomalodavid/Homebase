...
function installStyles(){
 ...
 .hb-daily-quote{margin:-3px 0 16px;padding:16px 18px 17px;border:1px solid rgba(217,120,31,.13);border-radius:20px;background:linear-gradient(145deg,rgba(255,253,249,.96),rgba(255,244,233,.76));box-shadow:0 7px 22px rgba(67,48,31,.055)}
 .hb-daily-quote-text{margin:0;font-family:ui-serif,"Iowan Old Style","Palatino Linotype",Palatino,Georgia,serif;font-size:18px;font-weight:600;line-height:1.38;letter-spacing:-.18px;color:#3b3027}
 ...
 @media(max-width:520px){.hb-daily-quote{padding:15px 16px 16px;border-radius:18px;margin-bottom:15px}.hb-daily-quote-text{font-size:17px;line-height:1.4}}
 `;
